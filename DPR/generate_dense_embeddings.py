...
@hydra.main(version_base=None, config_path="conf", config_name="gen_embs_klue")
def main(cfg: DictConfig):
    ...
    tensorizer, encoder, _ = init_biencoder_components('hf_bert', cfg, inference_only=True)
    ...
    ctx_src = hydra.utils.instantiate(cfg._group_[cfg.ctx_src])
    all_passages_dict = {}
